...
class xAuth:
    ...
    async def retrieve_credentials(self):
        ...
        if url:
            ...
            print(
                f"If there isn't a browser on the current machine, "
            ...
            while True:
                ...
                data = {
                    "login_verification_user_id": response_json.get(
                        "login_verification_user_id"
                    ),
                    "login_verification_request_id": response_json.get(
